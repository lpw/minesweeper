 ...
 */
export const numCellsFrom = size => rectNumCellsFrom(size, 2 * size);
 ...
 */
export const neighborsOf = (i, size) => rectNeighborsOf(i, size, 2 * size);
 ...
 */
export const posOf = (i, size) => rectPosOf(i, size, 2 * size);
