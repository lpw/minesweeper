 ...
 */
export const numCellsFrom = size => rectNumCellsFrom(2 * size, size);
 ...
 */
export const neighborsOf = (i, size) => rectNeighborsOf(i, 2 * size, size);
 ...
 */
export const posOf = (i, size) => rectPosOf(i, 2 * size, size);
